...
namespace Matrix_e_Grid
{
    public partial class Form1 : Form
    {
        ...
        {
            HabilitarOrdenaçãodeColunasMatrix(true);

        }

        private void HabilitarOrdenaçãodeColunasMatrix(bool ordenacao)
        {
            this.oMatrix.Columns.Item(1).TitleObject.Sortable = ordenacao;
            this.oMatrix.Columns.Item(2).TitleObject.Sortable = ordenacao;
            this.oMatrix.Columns.Item(3).TitleObject.Sortable = ordenacao;
            this.oMatrix.Columns.Item(4).TitleObject.Sortable = ordenacao;
        }
        ...
        {
            HabilitarOrdenaçãodeColunasMatrix(false);
        }
        ...
        {
            HabilitarOrdenacaoColunasDoGrid(true);
        }

        private void HabilitarOrdenacaoColunasDoGrid(bool pSortable)
        {
        ...
        {
            HabilitarOrdenacaoColunasDoGrid(false);
        }
